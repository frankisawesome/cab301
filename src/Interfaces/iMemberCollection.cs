...
namespace cab301
{
    ...
    interface iMemberCollection
    {
        ...
        iMember search(iMember aMember); //search a given member in this member collection. Return true if this memeber is in the member collection; return false otherwise.
